// src/pages/Catalogos/TypeUniform/TypesUniforms.tsx
// 🎯 PÁGINA STANDALONE - Puede usarse de forma independiente
import React from "react";
import TypesUniformsManagement from "./TypesUniformsManagement";

export default function TypesUniforms() {
  return (
