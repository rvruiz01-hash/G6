...
export default function NotificationDropdown() {
  ...
  const isOpen = openDropdown === "notifications"; // nombre único para este dropdown
  ...
  const handleClick = () => {
    toggleDropdown();
    setNotifying(false); // mantenemos la lógica de notificaciones nuevas
  };
  return (
    <div className="relative">
      ...
      >
        ...
        <img src={bellIcon} alt="Notificaciones" className="w-6 h-6" />
      </button>
      <Dropdown
        isOpen={isOpen}
